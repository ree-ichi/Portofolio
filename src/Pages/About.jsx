        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              An Information Systems student at Gunadarma University with a
              strong interest in front-end development. Passionate about
              creating engaging digital experiences and consistently striving to
